...
users[0].contacts << contacts[-1]
users[0].contacts << contacts[-2]
users[0].contacts << contacts[-3]
users[0].contacts << contacts[-4]
users[0].contacts << contacts[-5]
users[0].contacts << contacts[-6]
users[0].contacts << contacts[-7]
users[0].contacts << contacts[-8]
users[0].contacts << contacts[-9]
